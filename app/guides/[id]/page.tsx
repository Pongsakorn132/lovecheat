...
const guidesData: Record<string, any> = {
  'remote-assistance': {
    title: '🖥️ บริการช่วยเหลือรีโมท (Remote Assistance)',
    description: 'ขอความช่วยเหลือจากทีมงานผ่าน AnyDesk เมื่อแก้ปัญหาไม่ได้',
    warning: 'ข้อควรระวัง: อย่าส่งเลข AnyDesk ในห้องแชทสาธารณะ ให้ส่งใน Ticket ส่วนตัวเท่านั้น และอย่าขยับเมาส์สวนขณะทีมงานรีโมท',
    steps: [
      {
        title: '🔹 AnyDesk คืออะไร?',
        content: 'เป็นโปรแกรมที่ช่วยให้ทีมงานสามารถมองเห็นหน้าจอและควบคุมเมาส์/คีย์บอร์ดคอมพิวเตอร์ของลูกค้าได้จากระยะไกล เพื่อช่วยตั้งค่าหรือแก้ไขปัญหาเทคนิคให้แบบรวดเร็ว\n\n✅ ลูกค้าสามารถดึงเมาส์คืนหรือกดปิดโปรแกรมได้ตลอดเวลาเพื่อความปลอดภัย',
      },
      {
        title: '📥 ดาวน์โหลด AnyDesk',
        content: 'ดาวน์โหลดโปรแกรม AnyDesk (ขนาดไฟล์เล็กมาก ไม่ต้องติดตั้งก็รันได้เลย)',
        link: 'https://anydesk.com/en/downloads',
        linkText: 'ดาวน์โหลด AnyDesk',
      },
      {
        title: '1️⃣ เปิดโปรแกรม AnyDesk',
        content: '1. ดาวน์โหลด AnyDesk มาไว้ที่เครื่อง\n2. เปิดโปรแกรม (ไม่ต้องติดตั้ง รันได้เลย)\n3. ดูเลข "Your Address" (ตัวเลข 9-10 หลัก)\n4. จดเลขนี้ไว้',
      },
      {
        title: '2️⃣ เปิด Ticket ขอความช่วยเหลือ',
        content: '1. ไปที่ Discord Server\n2. เปิด Ticket ใหม่\n3. บอกปัญหาที่เจอ\n4. ส่งเลข AnyDesk Address ให้ทีมงาน\n\n⚠️ อย่าส่งเลขในห้องแชทสาธารณะ!',
      },
      {
        title: '3️⃣ รอทีมงาน Connect',
        content: '1. รอทีมงานกด Connect\n2. จะมีหน้าต่างขึ้นมาถามว่า "Accept?"\n3. กดปุ่ม "Accept" (สีเขียว) เพื่ออนุญาต\n4. ทีมงานจะเริ่มช่วยแก้ปัญหาให้',
      },
      {
        title: '4️⃣ ขณะทีมงานรีโมท',
        content: '✅ อย่าขยับเมาส์สวน - ให้ทีมงานทำงานได้สะดวก\n✅ สามารถดูได้ตลอด - เห็นทุกอย่างที่ทีมงานทำ\n✅ ดึงเมาส์คืนได้ตลอดเวลา - ถ้าต้องการหยุด\n✅ ปิดโปรแกรมได้ทันที - ถ้าไม่สบายใจ',
      },
      {
        title: '5️⃣ เสร็จแล้ว!',
        content: '1. ทีมงานจะแจ้งเมื่อแก้ปัญหาเสร็จ\n2. ทดสอบว่าใช้งานได้หรือไม่\n3. ปิดโปรแกรม AnyDesk\n4. ขอบคุณทีมงาน!',
      },
    ],
    tips: [
      'AnyDesk ปลอดภัย ใช้งานง่าย และไม่ต้องติดตั้ง',
      'อย่าส่งเลข AnyDesk ในที่สาธารณะ ส่งใน Ticket เท่านั้น',
      'ลูกค้าควบคุมได้ตลอด สามารถปิดโปรแกรมได้ทันที',
      'อย่าขยับเมาส์สวนขณะทีมงานรีโมท เพื่อความรวดเร็ว',
      'ถ้าไม่สบายใจ สามารถดึงเมาส์คืนหรือปิดโปรแกรมได้ทันที',
    ],
  },
  'ghost-spectre': {
